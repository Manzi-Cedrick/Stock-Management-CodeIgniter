...
<body>
    <div class="Container">
        ...
        <form action="<?= base_url().'index.php/StockInv/updateStock/'.$registered_details[0]['inventory_id']?>" method="post">
            <label>Quantity</label>
            <input type="number" name="quantity" placeholder="Add Quantity Name">
            <label>Product</label>
            <select value="<?= $registered_details[0]['productId']?>">
