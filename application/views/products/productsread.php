        ...
        <div class="body-all">
            <div class="user-all">
                <div class="users-now">
                    ...
                    <button><a href="<?php echo base_url('products/new');?>"><i class="fa-solid fa-plus" style="padding: 0 0.5em;"></i> Add Product</a></button>
                    <button><a href="<?php echo base_url('products/report');?>">Print Report</a></button>
                    </div>
                </div>
                    ...
                    <table class="fl-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url('products/delete/').$value['productId'];?>"><i class="fa-solid fa-trash"></i></a></td>
                                <td><a href="<?php echo base_url('products/edit/').$value['productId'];?>"><i class="fa-solid fa-pencil"></i></a></td>
                            </tr>
                            <?php 
                        }?>
                        </tbody>
